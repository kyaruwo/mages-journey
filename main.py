...
class travel:
    ...
    def shop(mage_id):
        ...
        for i in ipa:  #0 price, 1 i_atk, 2 item, 3 id
            if i[2] == buy:
                ...
                gold = s[3]
                atk = s[6]
                if gold < (i[0] * buy_count):  #gold check
    ...
    def battle(mage_id):
        ...
        if tier == "home":
            clear()
            return mage.title()
        if tier not in diff:  #default difficulty
            m = diff["E"]
            print("\nDifficulty set to E")
        else:
            m = diff[tier]
            ...
            if i[0] == role:
                ...
                while True:
                    ...
                    if act == "home":
                        clear()
                        mage.title()
                        return print("A wise choice indeed!")
                    hp -= (eatk - s[7])
                    ehp -= (s[6] - edef)
                    clear()
                    mage.title()
